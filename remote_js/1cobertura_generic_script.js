(function() {
    ...
    // Oculta #info-cliente-general si aparece
    ...
    const observer = new MutationObserver(() => ocultarInfoGeneral());
    observer.observe(document.body, { childList: true, subtree: true });
    ocultarInfoGeneral();

    // Espera que el score sea válido
